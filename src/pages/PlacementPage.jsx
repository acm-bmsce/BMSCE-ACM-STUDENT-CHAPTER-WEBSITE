    ...
    <div className="min-h-screen bg-black text-white overflow-x-hidden">
      ...
      <main className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 py-12 md:py-20">
        ...
        <section className="mb-20 md:mb-32 mt-10">
          <h2 className="text-center text-5xl sm:text-7xl font-robert-medium font-extrabold uppercase text-white mb-8 md:mb-12">
  INSIGHT SERIES
</h2>
        ...
        <section className="pt-12 md:pt-24 pb-12 md:pb-24 border-t border-white/10">
          <h2 className="text-center text-5xl sm:text-7xl font-robert-medium font-extrabold uppercase text-white mb-12 md:mb-16">
            100 DAYS OF CODE
          </h2>
