        ...
        <header className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-20 border-b border-white/10 pb-10">
          <div className="space-y-4">
            <div className="flex items-center gap-4 mb-2">
              ...
              <span className="text-[#7DD4EF] text-[10px] font-general uppercase tracking-[0.4em]">
                Legacy Nodes
              </span>
            </div>
          ...
          <p className="text-gray-500 max-w-sm text-sm md:text-right leading-relaxed uppercase tracking-widest text-[10px] font-general">
            A brief look at our recent milestones. Discover the history of our
        ...
        {fetchStatus === "loading" || fetchStatus === "waking" ? (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 animate-pulse">
            {[1, 2, 3].map((i) => (
              <div
                key={i}
                className="h-[450px] bg-white/5 rounded-3xl border border-white/10"
              />
            ))}
          </div>
        ) : fetchStatus === "error" ? (
          <div className="h-[200px] flex items-center justify-center border border-dashed border-red-500/20 rounded-3xl bg-red-500/5">
            <p className="text-red-400 tracking-widest uppercase text-xs font-general">
              ...
              >
                ...
                <div className="relative h-56 w-full overflow-hidden bg-gray-900">
                  ...
                  <div className="absolute top-4 left-4 bg-black/60 backdrop-blur-md border border-white/10 px-3 py-2 rounded-xl text-center">
                    ...
                    <div className="text-[9px] text-[#7DD4EF] uppercase tracking-widest font-general mt-1">
                      {session.parsedDate.toLocaleDateString("en-US", {
                        month: "short",
                      })}
                    </div>
                  </div>
                ...
                <div className="p-8 flex flex-col flex-1">
                  <span className="text-[9px] font-general text-gray-500 uppercase tracking-widest mb-3">
                  ...
                  <p className="text-gray-400 text-sm leading-relaxed line-clamp-3 mb-6 font-general">
                    {session.description}
                  </p>

                  <div className="mt-auto pt-6 border-t border-white/5 flex items-center justify-between text-xs text-gray-500 font-general uppercase tracking-widest">
          ...
          <div className="h-[200px] flex items-center justify-center border border-dashed border-white/10 rounded-3xl">
            <p className="text-gray-500 tracking-widest uppercase text-xs font-general">
