...
const eventData = [
    {
        ...
        description: 'The workshop, led by Mr. Sachin Lodha, Chief Scientist at TCS Research, was a fun and engaging session that introduced the concept of algorithms in a very relatable way.',
        date: '2025-06-27',
        image: pos1,
        fullDescription: 'The workshop, led by Mr. Sachin Lodha, Chief Scientist at TCS Research, was a fun and engaging session that introduced the concept of algorithms in a very relatable way. It started with a creative comparison asking, “Are you a good cook?” Just like a recipe gives step-by-step instructions to make a dish, an algorithm gives step-by-step instructions to solve a problem. A good recipe, or algorithm, not only gives the correct result but does so quickly and with less effort. This idea was made even more memorable with a reference to Amitabh Bachchan making an omelet in the movie Coolie. Participants were then introduced to what an algorithm actually is: a systematic process that solves a problem in a limited number of steps. To make the learning interactive, two classic problem scenarios were discussed. In the Hamlet’s Ski Rental Problem, Hamlet has to decide whether to rent or buy skis each day, without knowing how long he will continue skiing. This introduced the idea of online algorithms and decision-making under uncertainty. In the Treasure Hunt Problem, a blindfolded person stands at the origin while a treasure is hidden somewhere on the X-axis. The challenge is to find a strategy that helps the person locate the treasure with the least amount of walking. This introduced the doubling strategy and important concepts like competitive ratio and the Beeza-Yates theorem. The session used storytelling and real-life examples to explain technical concepts, making the learning enjoyable and memorable for everyone who attended'
        , outcomes: "The workshop helped participants gain a clear understanding of what algorithms are and how they can be used to solve real-life problems. Through engaging examples like Hamlet’s ski rental dilemma and the treasure hunt scenario, they learned how to make smart decisions even when the future is uncertain. The session introduced useful strategies such as the Doubling Strategy and explained key ideas like online algorithms, competitive ratio, and cost optimization in a simple and relatable way. It also encouraged logical thinking and step-by-step problem-solving. Overall, the workshop sparked curiosity and interest in algorithm design and competitive programming, making the learning process both fun and meaningful.",
        gallery: ["img/fwa-1.webp", "img/fwa-2.webp"],
        location: '1st Floor, PG Block',
        attendees: '63',
        year: "2025",
    },
    {
        ...
        gallery: ["img/gmg-1.webp", "img/gmg-2.webp", "img/gmg-3.webp", "img/gmg-4.webp"],
        location: 'AIML LAB 1',
        attendees: '32',
        year: "2025",
    },
    {
        ...
        image: pos3,
        fullDescription:
            "Duos Dash 3.0, organized by the BMSCE ACM Student Chapter during UTSAV 2025, the annual cultural fest of BMS College of Engineering, was a fast-paced and fun-filled event made for teams of two. The event had four unique rounds, each testing different skills like teamwork, creativity, and quick thinking. The first round, Bomb Diffusion, took place in Roblox, where one teammate gave instructions while the other worked to diffuse a virtual bomb. This round was all about communication and trust. In the second round, Fliptionary, one teammate drew in the air using a flipped screen, while the other had to guess the word—leading to lots of laughs and surprises. The third round, Movie Charades, had one teammate give a prompt to Google Gemini AI, and the other guessed the movie based on the AI-generated image. The final round, Draw & Dare, used UNO cards to assign fun tasks. Each team had three chances to draw a card and complete a dare based on its color, earning points as they went. Duos Dash 3.0 brought together tech, creativity, and teamwork in a fun and memorable way. It truly matched the energy and excitement of UTSAV 2025. "
        , outcomes: "All the participants left the event with a feeling of accomplishment after playing the games. They were all highly anticipating the results. These games fostered a sense of connection and strengthened the bond present between two friends. It also strengthened the teamwork and initiative of the BMSCE ACM Student Chapter beyond technical activities since we learnt what it is like to function as a group and complete our tasks.",
        gallery: ["img/dd-1.webp", "img/dd-2.webp", "img/dd-3.webp"],
        location: '2nd Floor Common Area, PJA Block',
        attendees: '86',
        year: "2025",
    },
    {
        id: '4',
        title: 'Clocked Out',
        description: 'BMSCE ACM Student Chapter organized an event on the account of Utsav, Clocked Out, this event’s aim was to challenge participants across multiple dimensions of strategy, memory, reflex, and logic. The event aimed to promote critical thinking, teamwork, and competitive spirit.',
        date: '2025-05-09',
        image: pos4,
        fullDescription: "Clocked Out was a fun and challenging three-round competition designed to test how well participants could think quickly, plan smartly in tricky situations, and solve clever puzzles.\n\n" +
            'In Round 1, called "Point Acquisition – Mini-Game Marathon," players took part in three exciting mini-games to collect points. In ChronoSort, they had to arrange numbered cards in the correct order as fast as possible. Nerf Nexus was a dart game where players could take risks using harder challenges to possibly double their points. Picture It tested memory by showing items briefly, then asking players to recall details. The points earned in this round were very important for moving ahead and came in handy later to unlock clues or mess with other teams.\n\n' +
            'Round 2 was "The Barter of Relics," a card trading game with a twist. Players got cool-looking fictional cards based on Marvel and sci-fi themes, but they didn’t know how valuable each card really was. They had to trade using their gut, charm, and strategy. At the end, the hidden values of the cards were revealed, which changed everyone’s scores and decided who stayed in the game.\n\n' +
            'Round 3, "The Final Convergence," brought it all together with a riddle-solving race. Teams faced a series of connected riddles based on five deep themes. Solving each riddle required spending their hard-earned points. They could also use special power-ups to delay or confuse their rivals. The event ended with a thrilling sprint to solve the final mystery first.'
        , outcomes: "The event helped participants improve their skills in strategy, memory, logic, and teamwork. It offered a fun yet competitive atmosphere with a variety of game formats that kept everyone engaged. Players got the chance to interact, collaborate, and build connections, whether playing solo or in teams. It also pushed them to think creatively and stay flexible under pressure. Overall, the event set a solid base for future interactive activities that blend entertainment with thoughtful challenges.",
        gallery: ["img/co-1.webp", "img/co-2.webp"],
        location: '2nd Floor PJA  Block, Common Area',
        attendees: '33',
        year: "2025",
    },
    {
    ...
    },
    {
        ...
        fullDescription:
            ...
            "Next was level A of the game where participants encountered 3 locked doors which were opened by answering the mathematical logic problem given on the door. Each level A door opened into 3 more level B doors which were locked with an English-based riddle on them. Each level B door opened into 3 doors of level C, which were locked with a logical reasoning-based question.\n\n" +
        ...
        location: 'PG Block, BMSCE, Bengaluru',
        attendees: '42',
        year: "2025",
    },
