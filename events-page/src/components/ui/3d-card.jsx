...
/** 🧩 CardContainer now forwards click and other props */
export const CardContainer = ({
  children,
  className,
  containerClassName,
  ...divProps   // captures onClick, id, style, etc.
}) => {
    ...
    <MouseEnterContext.Provider value={[isMouseEntered, setIsMouseEntered]}>
      ...
      >
        <div
          ...
          {...divProps}  // 🛠 Forward props for click handling etc.
        >
          {children}
        </div>
      </div>
