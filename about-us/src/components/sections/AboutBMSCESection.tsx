...
export const AboutBMSCESection: React.FC = () => {
  ...
  const journeyData = [
    { 
      ...
      image: "https://placehold.co/600x400/1e293b/FFFFFF?text=2018",
      description: "The beginning of our community, founded by a small group of innovators."
    },
    { 
      year: "2020", 
      title: "500+ Members Milestone",
      image: "https://placehold.co/600x400/1e293b/FFFFFF?text=2020",
      description: "Our community grew into one of the largest on campus."
    },
    { 
      year: "2022", 
      title: "National Recognition Award",
      image: "https://placehold.co/600x400/1e293b/FFFFFF?text=2022",
      description: "Recognized for excellence and contribution to the tech community."
    },
    { 
      year: "2024", 
      title: "Innovation Hub Launch",
      image: "https://placehold.co/600x400/1e293b/FFFFFF?text=2024",
      description: "Opened a new state-of-the-art lab for member projects."
    }
  ];
        ...
        <div className="mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 2xl:grid-cols-2 gap-8 justify-items-center">
            {visionItems.map((item, index) => (
              <div
                key={index}
                className="group relative border border-acm-gold/30 rounded-2xl p-8 transform transition-all duration-700 hover:scale-105 animate-slide-in-3d w-full min-h-[280px]"
                style={{ animationDelay: `${index * 0.2}s` }}
              >
                <div className="flex items-center mb-6">
                  {/* CORRECTED: Restored the background gradient to the icon container */}
