      ...
      <div className="max-w-4xl mx-auto px-4 w-full">
        ...
        <div className="space-y-12 flex flex-col items-center">
          ...
          <div className="w-full max-w-2xl">
            <h3 className="font-bebas text-3xl text-acm-gold mb-8 text-center">GET IN TOUCH</h3>
            
            <div className="space-y-6">
              {contactInfo.map((contact, index) => (
                <div
                  key={index}
                  className="group flex items-center space-x-4 bg-gradient-to-r from-acm-black/50 to-acm-gold/10 backdrop-blur-md border border-acm-gold/30 rounded-xl p-6 transform transition-all duration-500 hover:scale-105 animate-slide-in-3d"
                  style={{ animationDelay: `${index * 0.2}s` }}
                >
                  <div className={`w-12 h-12 ${contact.color} bg-acm-black/30 rounded-xl flex items-center justify-center group-hover:rotate-12 transition-transform duration-300`}>
                    <contact.icon size={24} />
                  </div>
                  <div>
                    <div className="font-bricolage text-acm-white/60 text-sm">{contact.label}</div>
            ...
            {/* Office Hours */}
            <div className="bg-gradient-to-br from-acm-blue/20 to-acm-red/20 backdrop-blur-md border border-acm-gold/30 rounded-xl p-6 mt-8">
              <h4 className="font-bricolage text-xl font-bold text-acm-gold mb-4 text-center">Office Hours</h4>
          ...
          <div className="w-full max-w-md">
            ...
            <div className="flex justify-center gap-6">
              {socialLinks.map((social, index) => (
                <button
                  key={index}
                  className={`group bg-gradient-to-br from-acm-black/70 to-acm-gold/20 backdrop-blur-md border border-acm-gold/30 rounded-xl p-6 transform transition-all duration-500 hover:scale-105 hover:-rotate-2 animate-slide-in-3d ${social.color} relative`}
                  style={{ animationDelay: `${index * 0.1}s` }}
                >
                  <social.icon size={32} className="mx-auto mb-3 text-acm-white" />
                  <div className="font-bricolage text-acm-white font-medium mb-1">{social.label}</div>
                  <div className="font-bellefair text-acm-white/60 text-sm">{social.handle}</div>
                  <ExternalLink size={16} className="absolute top-4 right-4 text-acm-gold/60 group-hover:text-acm-gold transition-colors duration-300" />
                </button>
              ))}
            </div>
          </div>
            ...
            <div className="bg-gradient-to-r from-acm-gold/20 via-acm-blue/20 to-acm-red/20 backdrop-blur-md border border-acm-gold/30 rounded-2xl p-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <input
                  ...
                  className="flex-1 bg-acm-black/50 border border-acm-gold/30 rounded-lg px-4 py-3 text-acm-white placeholder-acm-white/50 focus:border-acm-gold focus:outline-none transition-colors duration-300"
                />
                <button className="bg-gradient-to-r from-acm-red to-acm-blue text-acm-white font-bricolage font-bold py-3 px-6 rounded-lg transform transition-all duration-300 hover:scale-105">
                  SUBSCRIBE
                </button>
              </div>
            </div>
              ...
              <form className="space-y-4">
                <div className="grid md:grid-cols-2 gap-4">
                  <input
                    ...
                    className="w-full bg-acm-black/50 border border-acm-gold/30 rounded-lg px-4 py-3 text-acm-white placeholder-acm-white/50 focus:border-acm-gold focus:outline-none transition-colors duration-300"
                  />
                  <input
                    type="email"
                ...
                <button
                  type="submit"
                  className="w-full bg-gradient-to-r from-acm-gold to-acm-red text-acm-black font-bricolage font-bold py-3 px-6 rounded-lg transform transition-all duration-300 hover:scale-105 hover:shadow-2xl"
                >
                  SEND MESSAGE
                </button>
              </form>
